...
function PrivacyPolicy() {
  return (
    <React.Fragment>
      <NavbarFinal />
      <Container>
        <h2 style={{ textAlign: "center" }} className="mt-4">
          <b>PRIVACY POLICY</b>
        </h2>
        <p>
          1. <b>Introduction</b>
        ...
        <p>
          Welcome to <b> Bunkercart</b>.
        </p>
        <p>
          <b>Bunkercart</b> (“us”, “we”, or “our”) operates{" "}
          <b>bunkercart.com</b> (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>bunkercart.com</b>, and
        ...
        <p>
          <b>SERVICE</b> means the bunkercart.com website operated by
          Bunkercart.
        </p>
        <p>
        ...
        <p>Bunkercart uses the collected data for various purposes:</p>
        ...
        <p>
          Bunkercart will take all the steps reasonably necessary to ensure that
        ...
        <p>
          ...
          us at <b>vinitjoshi.2345@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>vinitjoshi.2345@gmail.com</b>
          .
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>vinitjoshi.2345@gmail.com</b>.
        </p>
      </Container>
    </React.Fragment>
  );
